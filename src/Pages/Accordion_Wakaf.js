...
const Wakaf = () => {
    return(
        <Accordion defaultActiveKey="0" className="Accordion_border">
            ...
            <Accordion.Header>Pengertian Wakaf</Accordion.Header>
                <Accordion.Body>
            ...
            <Accordion.Header>Wakaf Menurut Abu Hanifah</Accordion.Header>
                <Accordion.Body>
            ...
            <Accordion.Header>Wakaf Menurut Mazhaf Maliki</Accordion.Header>
                <Accordion.Body>
            ...
            <Accordion.Header>Wakaf Menurut Mazhab Syafi&#39;I dan Ahmad bin Hambal</Accordion.Header>
                <Accordion.Body>
            ...
            <Accordion.Header>Wakaf Menurut Mazhab Lain</Accordion.Header>
                <Accordion.Body>
            ...
            <Accordion.Header>Rukun Wakaf</Accordion.Header>
                <Accordion.Body>
            ...
            <Accordion.Header>Syarat-syarat orang yang berwakaf (al-waqif)</Accordion.Header>
                <Accordion.Body>
            ...
            <Accordion.Header>Syarat-syarat harta yang diwakafkan (al-mauquf)</Accordion.Header>
                <Accordion.Body>
            ...
            <Accordion.Header>Syarat-syarat orang yang menerima manfaat wakaf (al-mauquf alaih)</Accordion.Header>
                <Accordion.Body>
            ...
            <Accordion.Header>Syarat-syarat Shigah</Accordion.Header>
                <Accordion.Body>
